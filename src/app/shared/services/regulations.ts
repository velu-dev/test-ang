export const Regulations = [
    ...
    },
    {
        ...
        "section_number": "§26(b)",
        "section_title": "QME Office Locations and Changes of Office Locations",
        "regulation_text": "(b) An office location shall be maintained by a QME at least 180 days from the date the Medical Unit lists the office as available to perform comprehensive medical-legal evaluations, except upon a showing of good cause to the Medical Director. For purposes of this section the term “good cause” includes, but is not limited to: (1) natural disasters or other community catastrophes that interrupt the operation of the evaluator's business; (2) the expiration of a written lease agreement of not less than 12 months duration for an office location defined in subdivision (a); (3) the sale of real property by the QME of an office location defined in subdivision (a) where the QME vacates the property."
    },
    {
        "code": "10",
        "section_number": "§26(c)",
