...
@Component({
  selector: 'app-historian-user',
  templateUrl: './historian-user.component.html',
  styleUrls: ['./historian-user.component.scss'],
  animations: [
...
export class HistorianUserComponent implements OnInit {
  screenWidth: number;
  xls = globals.xls;
  roles: Role[];
  selectedRole: any = [];
  ...
  gotoEdit(data) {
    this.router.navigate(["/vendor/historian/users/" + data.id])
  ...
  navigate() {
    this.router.navigate(['/vendor/historian/users/new'])
  }
