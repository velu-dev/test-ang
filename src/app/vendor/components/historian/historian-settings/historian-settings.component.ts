...
@Component({
  selector: 'app-historian-settings',
  templateUrl: './historian-settings.component.html',
  styleUrls: ['./historian-settings.component.scss']
})
export class HistorianSettingsComponent implements OnInit {
