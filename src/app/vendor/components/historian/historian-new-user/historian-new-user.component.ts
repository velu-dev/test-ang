...
@Component({
  selector: 'app-historian-new-user',
  templateUrl: './historian-new-user.component.html',
  styleUrls: ['./historian-new-user.component.scss']
})
export class HistorianNewUserComponent implements OnInit {
  userForm: FormGroup;
  isSubmitted = false;
