...
@Component({
  selector: 'app-summarizer-user',
  templateUrl: './summarizer-user.component.html',
  styleUrls: ['./summarizer-user.component.scss'],
  animations: [
...
export class SummarizerUserComponent implements OnInit {
  screenWidth: number;
  xls = globals.xls;
  roles: Role[];
  selectedRole: any = [];
