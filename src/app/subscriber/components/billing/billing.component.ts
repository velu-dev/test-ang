...
export class BillingComponent implements OnInit {
  ...
  gotoBilling(e) {
    ...
    this.router.navigateByUrl(this.router.url + '/claimant/' + e.claimant_id + '/claim/' + e.claim_id + '/billable-item/' + e.billable_item_id + '/billing/' + e.bill_id + '/' + e.bill_submission_type.toLowerCase())
  }
