  ...
  constructor(private breakpointObserver: BreakpointObserver, private route: ActivatedRoute,
    ...
    this.isHandset$.subscribe(res => {
      ...
      if (res) {
        ...
        this.columnName = ["", "Date Requested", "File Name", "Rush Request?", "Date Received", "Download"]
        this.columnsToDisplay = ['doc_image', "date_of_request", 'file_name', 'service_priority', "date_of_communication", 'download']
      }
    })
  }
