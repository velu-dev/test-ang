  ...
  constructor(private breakpointObserver: BreakpointObserver,
    ...
    this.isHandset$.subscribe(res => {
      ...
      if (res) {
        ...
        this.columnName = ["Ref #", "File Name", "Action", "Rush Request?", "Document" + '\n' + "Lines", "Date Requested", "Date Received", "Download Submitted" + '\n' + "Items", "Download Compiled" + '\n' + "Document", "Further Information"]
        this.columnsToDisplay = ['request_reference_id', 'file_name', 'actions', 'service_priority', "document_lines", "date_of_request", "date_of_communication", 'download', 'download1', 'further_info']
      }
    })
    // this.isHandset$.subscribe(res => {
    //   this.isMobile = res;
