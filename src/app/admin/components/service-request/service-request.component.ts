  ...
  constructor(private breakpointObserver: BreakpointObserver, private userService: UserService) {
    this.isHandset$.subscribe(res => {
      ...
      if (res) {
        ...
        this.columnName = ["Subscriber Name", "Subscriber Account", "Requester Name", "Claim #", "Claim Reference #", "Service Type", "Request Date Time", "Request Reference", "Service Priority", "Service Provider Name", "Service Provider Account", "Service Status"]
